...
export interface CompactionPolicyConfig {
  ...
  /** Automatic and `/compact` summarization output cap. Defaults to `8192`. */
  maxTokens?: number
  /** Extra attempts after the first compaction when pressure remains above threshold. Defaults to `1`. */
  compactionRetries?: number
  /** Maximum retries after canonical context overflow; `0` disables recovery. Defaults to `1`. */
  maxOverflowRetries?: number
  /** Selected-input fraction used for a reviewed range's output budget. Defaults to `0.25`. */
  preparationOutputRatio?: number
  /** Minimum reviewed-range output budget before model and context caps. Defaults to `16000`. */
  preparationMinOutputTokens?: number
  /** Maximum reviewed-range output budget before model and context caps. Defaults to `128000`. */
  preparationMaxOutputTokens?: number
  /** Maximum concurrent range-preparation provider calls. Defaults to `2`. */
...
来源：[`packages/compaction/compaction-basic/src/types.ts:46`](../packages/compaction/compaction-basic/src/types.ts)
...
<a id="deepseek-aidsh-computer-use-cua-driver"></a>

## `@deepseek-ai/dsh-computer-use-cua-driver`

Requires: `computerUse`
...
Source: [`packages/computer-use/computer-use-cua-driver/src/index.ts:32`](../packages/computer-use/computer-use-cua-driver/src/index.ts)
...
来源：[`packages/interaction/permission-presets/src/index.ts:147`](../packages/interaction/permission-presets/src/index.ts)
...
来源：[`packages/sandbox/sandbox-policy/src/index.ts:66`](../packages/sandbox/sandbox-policy/src/index.ts)
...
<a id="deepseek-aidsh-session-context"></a>

## `@deepseek-ai/dsh-session-context`

需要：`sessions` · `tokenMeter` · `compactions`
...
来源：[`packages/session/session-context/src/types.ts:18`](../packages/session/session-context/src/types.ts)
...
来源：[`packages/session/session-persistence-jsonl/src/index.ts:108`](../packages/session/session-persistence-jsonl/src/index.ts)
...
来源：[`packages/context/time-context/src/index.ts:26`](../packages/context/time-context/src/index.ts)
...
<a id="deepseek-aidsh-tool-session-context"></a>

## `@deepseek-ai/dsh-tool-session-context`

需要：`tools` · `systemPrompt` · `sessionContext`
...
来源：[`packages/session/tool-session-context/src/index.ts:20`](../packages/session/tool-session-context/src/index.ts)
...
来源：[`packages/interaction/user-approval/src/index.ts:162`](../packages/interaction/user-approval/src/index.ts)
...
- `@deepseek-ai/dsh-plugin-catalog-tools` — 需要 `tools` · `pluginCatalog` · `pluginInstall`（[`packages/workbench/tool-plugin-catalog/src/index.ts`](../packages/workbench/tool-plugin-catalog/src/index.ts)）
