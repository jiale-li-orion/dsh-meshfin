...
Source: [`packages/interaction/permission-presets/src/index.ts:147`](../packages/interaction/permission-presets/src/index.ts)
...
Requires: `sessions` · `tokenMeter` · `compactions`
...
Source: [`packages/session/session-context/src/types.ts:18`](../packages/session/session-context/src/types.ts)
...
Requires: `tools` · `systemPrompt` · `sessionContext`
...
Source: [`packages/session/tool-session-context/src/index.ts:20`](../packages/session/tool-session-context/src/index.ts)
...
Source: [`packages/workbench/workbench-bytes/src/index.ts:105`](../packages/workbench/workbench-bytes/src/index.ts)
