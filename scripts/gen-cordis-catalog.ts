...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  pluginCatalog: 'plugin-catalog.md',
  pluginInstall: 'plugin-catalog.md',
  ...
  sessionContext: 'session-context.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SubprocessTerminalInspectOptions: 'subprocess.md',
  SubprocessTerminalSpawnSpec: 'subprocess.md',
  CodeRunRequest: 'code-runtime.md',
  CodeRunResult: 'code-runtime.md',
  CompactionEngine: 'compaction.md',
  CompactionResult: 'compaction.md',
  CompactionPreparation: 'compaction.md',
  CompactionPreparationProgress: 'compaction.md',
  CompactionPreparationRequest: 'compaction.md',
  ...
  TokenRangeMeasurement: 'token-meter.md',
  ContextHistoryReadResult: 'session-context.md',
  ContextHistoryReadRequest: 'session-context.md',
  ContextHistorySearchRequest: 'session-context.md',
  ContextHistorySearchResult: 'session-context.md',
  ContextInspectRequest: 'session-context.md',
  ContextPreparation: 'session-context.md',
  ContextPreparationEditRequest: 'session-context.md',
  ContextPreparationRef: 'session-context.md',
  ContextPrepareRequest: 'session-context.md',
  ContextRewriteRequest: 'session-context.md',
  ContextRewriteResult: 'session-context.md',
  ContextSnapshot: 'session-context.md',
  ContextUnitDetail: 'session-context.md',
  ContextUnitId: 'session-context.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  WorkbenchView: 'shared workbench view state is owned by packages/workbench/workbench/README.md',
  WorkbenchListing: 'fenced directory listing is owned by packages/workbench/workbench/README.md',
  WorkbenchDirEntry: 'listed directory child is owned by packages/workbench/workbench/README.md',
  PluginCatalogEntry: 'catalog entry vocabulary is owned by packages/workbench/plugin-catalog/README.md',
